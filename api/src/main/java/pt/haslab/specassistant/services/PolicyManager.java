...
public class PolicyManager {
    ...
    public void djisktra(ObjectId graph_id, PolicyOption policyOption) {
        ...
        BinaryOperator<DjisktraNode> best = switch (policyOption.getObjective()) {
        ...
        while (!batch.isEmpty()) {
            ...
            Map<Boolean, List<DjisktraNode>> nodes = batch.stream().collect(Collectors.groupingBy(x -> x.score <= target, Collectors.toList()));
